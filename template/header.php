      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              <!-- link to donation.php -->
              <li><a href="donation.php"><span class="glyphicon glyphicon-paperclip"></span>&nbsp; Upload</a></li>
...
<div class="jumbotron" style="position: relative; height: 400px; overflow: hidden;">
  <!-- Blurred Background Image -->
  <div style="
    background: url('bootstrap/img/profiles.jpg') no-repeat center center;
  ...
  <div style="
    ...
    <p>Here you can find your favourite books and order them online!</p>
      </div>
  </div>
</div>
    </div>
