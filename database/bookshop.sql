...
--
-- Host: localhost
-- Generation Time: May 02, 2022 at 02:18 PM
...
INSERT INTO `books` (`book_isbn`, `type`, `book_title`, `book_author`, `book_image`, `book_descr`, `book_price`, `publisherid`, `categoryid`) VALUES
('3243', 'New Book', 'dsasd', 'dsdad', 'banner.jpeg', 'asdasd', '0.00', 15, 14),
('876213', 'Donating', 'adas', 'sad', 'banner.jpeg', 'sadad', '0.00', 15, 13),
('8768', '', 'India', 'test', 'banner.jpeg', 'dasdsad', '2100.00', 14, 12),
...
--
ALTER TABLE `publisher`
  MODIFY `publisherid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
COMMIT;
